	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<table class="table">
				...
				<?php
					foreach($list as $v){
						echo '<tr><td>'.$v['id'].'</td><td>'.$v['goods_name'].'</td><td>'.$v['counts'].'</td><td>'.$v['rediscount'].'</td><td><a href="javascript:void(0);" class="btn btn-default setcount" data-id='.$v['id'].' data-goodsname='.$v['goods_name'].' data-counts='.$v['counts'].'>修改库存</a><a href="./index1.php?app=app&c=order&a=orderList&gid='.$v['id'].'" class="btn btn-default">查看订单</a></td></tr>';
					}
				?>
				</table>
		</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="post-modal-data" data-posttarget="./index1.php?app=app&c=goods&a=setGoodsCount">Save</button>
      </div>
    </div>
  </div>
</div>
